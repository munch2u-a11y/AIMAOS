...
- Added persistent background jobs and managed daemon heartbeat reporting.
- Added loopback-first networking, optional token authentication, CSRF/origin checks, restrictive browser headers, and safe file APIs.
- Added approved storage roots, upload allowlists and limits, path validation, safer generated names, and developer-tool gates.
